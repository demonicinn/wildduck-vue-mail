define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user",
            "description": "<p>ID of the user if the address belongs to an User</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "results.user",
            "description": "<p>User ID this address belongs to if this is an User address</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
  ...
  },
  {
    ...
    "name": "CheckTotp2FA",
    "group": "TwoFactorAuth",
    "description": "<p>This method checks if a TOTP token provided by an User is valid for authentication</p>",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    ...
    "name": "Disable2FA",
    "group": "TwoFactorAuth",
    "description": "<p>This method disables all 2FA mechanisms an user might have set up</p>",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    ...
    "title": "Disable custom 2FA for an user",
  ...
  },
  {
    ...
    "name": "DisableTotp2FA",
    "group": "TwoFactorAuth",
    "description": "<p>This method disables TOTP for an user. Does not affect other 2FA mechanisms an user might have set up</p>",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  },
  {
    "type": "put",
    "url": "/users/:user/2fa/custom",
    "title": "Enable custom 2FA for an user",
  ...
  },
  {
    ...
    "name": "EnableTotp2FA",
    "group": "TwoFactorAuth",
    "description": "<p>This method enables TOTP for an user by verifying the seed value generated from 2fa/totp/setup</p>",
    "header": {
      "fields": {
        "Header": [
          {
